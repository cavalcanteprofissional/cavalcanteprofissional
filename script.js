...
const translations = {
    pt: {
        ...
        'experience.2.title': 'Analista de Marketing e Comercial',
        'experience.2.1': 'Planejamento e gestão de campanhas digitais (Google Ads, Meta Ads) com monitoramento de KPIs.',
        'experience.2.2': 'Implementação de estratégias de SEO e SEM, resultando em aumento do tráfego orgânico.',
        'experience.2.3': 'Criação e edição de conteúdo audiovisual para redes sociais e funis de vendas.',
        'experience.2.4': 'Gerenciamento de CRM via ERP interno.',
        'experience.2.5': 'Suporte à equipe comercial na prospecção e fidelização de clientes.',
        
        'experience.3.title': 'Analista de Marketing | Assistente de Marketing',
        'experience.3.1': 'Desenvolvimento e monitoramento de campanhas promocionais.',
        'experience.3.2': 'Implementação de estratégias de SEO/SEM e gestão de conteúdo para site e redes sociais.',
        'experience.3.3': 'Criação de conteúdo gráfico e manutenção dos canais de comunicação digitais.',
        
        'experience.4.title': 'Técnico em Informática e Redes',
        'experience.4.1': 'Montagem, manutenção e configuração de infraestrutura de TI (computadores, servidores, redes TCP/IP, Wi-Fi).',
        'experience.4.2': 'Suporte técnico remoto e presencial, instalação de software e permissionamento de acesso.',
        'experience.4.3': 'Consultoria técnica e elaboração de propostas para licitações de equipamentos.',
    ...
    en: {
        ...
        'experience.2.title': 'Marketing and Commercial Analyst',
        'experience.2.1': 'Planning and management of digital campaigns (Google Ads, Meta Ads) with KPI monitoring.',
        'experience.2.2': 'Implementation of SEO and SEM strategies, resulting in increased organic traffic.',
        'experience.2.3': 'Creation and editing of audiovisual content for social media and sales funnels.',
        'experience.2.4': 'CRM management via internal ERP.',
        'experience.2.5': 'Support to the commercial team in customer prospecting and retention.',
        
        'experience.3.title': 'Marketing Analyst | Marketing Assistant',
        'experience.3.1': 'Development and monitoring of promotional campaigns.',
        'experience.3.2': 'Implementation of SEO/SEM strategies and content management for website and social media.',
        'experience.3.3': 'Creation of graphic content and maintenance of digital communication channels.',
        
        'experience.4.title': 'IT and Networks Technician',
        'experience.4.1': 'Assembly, maintenance, and configuration of IT infrastructure (computers, servers, TCP/IP networks, Wi-Fi).',
        'experience.4.2': 'Remote and on-site technical support, software installation, and access permissioning.',
        'experience.4.3': 'Technical consulting and preparation of proposals for equipment bidding.',
